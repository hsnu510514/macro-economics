...
async function getStartManifest() {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-BEMCyigH.js");
...
const manifest = { "f76e8f8721c12c8547a3ced6a10916f5b5076c1a10dcbeaa607360ce419d0a48": {
  functionName: "personServerFn_createServerFn_handler",
  importer: () => import("./assets/deferred-CosnZVSY.js")
}, "fc3988c64f434639dfd4eab3f926b87ee39cc0c14f65b4d0e852c7fd73279a3b": {
  functionName: "slowServerFn_createServerFn_handler",
  importer: () => import("./assets/deferred-CosnZVSY.js")
}, "94b930b6f87f315f197e48e360f9e92c9d786a73504cc1935ac61723a07b4986": {
  functionName: "loadDashboard_createServerFn_handler",
  importer: () => import("./assets/dashboard-DEjmZB-s.js")
}, "6e3de763758e78f17a6cb1ceba141c803418d512e0d0f85a439a15b6d3efa93d": {
  functionName: "loadIndicatorDetail_createServerFn_handler",
  importer: () => import("./assets/indicators._id-lIT9e-oj.js")
}, "0029094260fc8f554fa3ac223696de0e9591567ec6420250e896c91244c812c5": {
  functionName: "fetchPost_createServerFn_handler",
  importer: () => import("./assets/posts-DOERrLE-.js")
}, "cbb8ca69048418e62742f2c511faa56326b80ace384144a35bb3e0bf5e8124be": {
  functionName: "fetchPosts_createServerFn_handler",
  importer: () => import("./assets/posts-DOERrLE-.js")
}, "510293d7219a31853226fdd60f9b9d653de03fd39d3ee2dbe183869fa5a214f5": {
  functionName: "saveLayoutFn_createServerFn_handler",
  importer: () => import("./assets/dashboard-DnZOWC1I.js")
}, "4b31f34768336ef9aca76b7a0e1ee834c2cc009b9b2945f0c739ed1c4d90e18b": {
  functionName: "saveNotes_createServerFn_handler",
  importer: () => import("./assets/indicators._id-CQqnTtEV.js")
} };
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./assets/router-Cpa8nh8A.js").then((n) => n.r);
    }
    if (startEntry === null) {
